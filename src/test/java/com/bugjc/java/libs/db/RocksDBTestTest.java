...
class RocksDBTestTest {
    private String dbFolder = new File("D:\\data\\test\\").getAbsolutePath();

    @Test
    void ttlDBOpen() throws RocksDBException, InterruptedException {
    ...
    @Test
    void ttlDBOpenWithTtl() throws RocksDBException, InterruptedException {
        try (final Options options = new Options().setCreateIfMissing(true).setMaxCompactionBytes(0);
    ...
    @Test
    void ttlDbOpenWithColumnFamilies() throws RocksDBException,
    ...
    @Test
    void createTtlColumnFamily() throws RocksDBException, InterruptedException {
